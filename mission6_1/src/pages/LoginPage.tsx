...
const LoginPage = () => {
    ...
    // ProtectedLayout에서 전달한 '원래 가려던 페이지' 정보
        ...
        <div className="flex flex-col items-center justify-center h-full gap-4">
            ...
            <div className="flex flex-col gap-3">
                ...
                <button
                    ...
                    >
                    <div className="bg-blue-600 text-white py-3 rounded-md text-lg font-medium flex items-center justify-center gap-3">
                        <span>구글 로그인</span>
                    </div>
                </button>
